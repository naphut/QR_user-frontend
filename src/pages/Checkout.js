...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.customer_name || !formData.customer_email || 
        !formData.customer_phone || !formData.customer_address) {
    ...
    try {
      ...
      const orderResponse = await axios.post(`${API_URL}/orders/create`, orderData, { headers });
      ...
      const errorMessage = error.response?.data?.detail || 'Failed to process order. Please try again.';
